...
export const PRESETS_BY_ROLE: Record<Role, string[]> = {
  sales_rep: [
    '我手上有哪些待发货订单有交付风险？',
    '我这个月的商机漏斗情况怎么样？',
    // 客户必须是张伟名下的（华宁自动化归 U-010，他根本看不到）——
    // 在第一印象的位置摆一个他无权查的客户名，面试官翻一下客户页就穿帮了。
    '帮我给汇川设备建一个下周的回访任务',
  ],
  sales_director: [
    '团队里逾期超过 30 天的应收有哪些？',
  ...
  supply_chain: [
    ...
    // 这条是留给澄清闸的演示素材：说出来像是很清楚，实际上库里有 11 个伺服电机 SKU。
    // 和 CEO 那条「公司最大的客户是谁？」是同一个用途，见 clarify.test.ts 的 deliberate 集合。
    '伺服电机还有多少库存？',
  ],
  ceo: [
    '公司最大的客户是谁？',
